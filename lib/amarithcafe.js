                    ...
                    axios.post(`https://transaction.hostedpayments.com/?TransactionSetupID=${code}`, data, {
                        ...
                        switch (result.trim()) {
                            case 'Call Issuer':
                                ...
                                Queue.sendToQueue(false, '#'+id + 'atividade',  cards[i].card.number + ' Verificado e foi APROVADO, Aguarde..' )
                            ...
                            default:
                                let negado = '<tr role="row" class="odd">' +
                                    ...
                                    '<span class="label label-sm label-info">ELPATRON</span>' +
                                    '</td> </tr>'
                                Queue.sendToQueue(false, '#' + id+'atividade', cards[i].card.number + ' Verificado e  foi NEGADO Agurade..' )
