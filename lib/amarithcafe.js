                    ...
                    axios.post(`https://transaction.hostedpayments.com/?TransactionSetupID=${code}`, data, {
                        ...
                        switch (result.trim()) {
                            case 'Call Issuer':
                                ...
                                Queue.sendToQueue(false, '#' + id + 'atividade',  '<span class="label label-sm label-success">'+cards[i].card.number+' ELPATRON</span>')
                            ...
                            default:
                                let negado = '<tr role="row" class="odd">' +
                                    ...
                                    '<span class="label label-sm label-info">ELPATRON</span>' +
                                    '</td> </tr>'
                                Queue.sendToQueue(false, '#' + id + 'atividade', '<span class="label label-sm label-danger">'+cards[i].card.number+' ELPATRON</span>')
